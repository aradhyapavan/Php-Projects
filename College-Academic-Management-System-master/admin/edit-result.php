...
$ret = "SELECT tblstudents.StudentName,tblclasses.branch_name,tblclasses.sem from tblresult join tblstudents on tblresult.StudentId=tblresult.StudentId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblclasses on tblclasses.id=tblstudents.BranchId where tblstudents.StudentId=:stid limit 1";
...
{  ?>
                                            ...
                                            <label for="default" class="col-sm-2 control-label">Branch</label>
                                                        <div class="col-sm-10">
<?php echo htmlentities($row->branch_name)?>(<?php echo htmlentities($row->sem)?>)
                                                        </div>
                                                    </div>
<div class="form-group">

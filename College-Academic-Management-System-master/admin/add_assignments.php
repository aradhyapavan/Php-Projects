...
move_uploaded_file($files_tmp,"../admin/assignments/$files");
...
$ret=mysqli_query($con,"insert into assignments(description,branchid,subjectcode,ldts,year,file_type,file_size,files) values('$description','$Branch','$sub','$ldts','$year','$file_type','$file_size','$files')");
...
<html lang="en">
    <head>
        ...
        <title>BCE Admin  Add-Assignments </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Add Assignments</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Assignments and Refernce Links</li>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Last Date To Submit</label>
<div class="col-sm-10">
<input type="date"  class="form-control" name="ldts" id="ldts"  required="required" autocomplete="off">
</div>
</div>

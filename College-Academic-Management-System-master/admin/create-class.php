...
$sql="INSERT INTO  tblclasses(branch_name,sem) VALUES(:branch_name,:sem)";
...
<html lang="en">
    <head>
        ...
        <title>BCE Admin Add Branch</title>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                			<select name="branch_name" id="branch_name" class="form-control"  required="required">
<option>Select Branch</option>
<option>Computer Science</option>
<option>Informtion Science</option>
<option>Civil</option>
<option>Mechanical</option>
<option>Electonic and Communication</option> </select> 

...
{   ?>
  <p> <?php echo htmlentities($result->StudentName); ?><input type="text"  name="marks[]" value="" class="form-control" required="" placeholder="Enter total no of classes Attended" autocomplete="off"></p>
...
<p>
<?php
echo "<span style='color:red'> Attendence Already Declared .</span>";

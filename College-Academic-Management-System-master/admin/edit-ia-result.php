...
$sql="update tbliaresult  set marks=:mrks where id=:iid ";
$query = $dbh->prepare($sql);
$query->bindParam(':mrks',$mrks,PDO::PARAM_STR);
$query->bindParam(':iid',$iid,PDO::PARAM_STR);
$query->execute();

$msg=" Ia Result info updated successfully";
}
}
}
...
<h5 style="text-align:center;">First IA Result</h5>

<?php 

$ret = "SELECT tblstudents.StudentName,tblclasses.branch_name,tblclasses.sem from tbliaresult join tblstudents on tbliaresult.StudentId=tbliaresult.StudentId join tblsubjects on tblsubjects.id=tbliaresult.SubjectId join tblclasses on tblclasses.id=tblstudents.BranchId where tblstudents.StudentId=:stid limit 1";
...
<?php 
$sql = "SELECT distinct tblstudents.StudentName,tblstudents.StudentId,tblclasses.branch_name,tblclasses.sem,tblsubjects.SubjectName,tbliaresult.marks,tbliaresult.id as resultid from tbliaresult join tblstudents on tblstudents.StudentId=tbliaresult.StudentId join tblsubjects on tblsubjects.id=tbliaresult.SubjectId join tblclasses on tblclasses.id=tblstudents.BranchId where tblstudents.StudentId=:stid and tbliaresult.iatype='first' ";
$query = $dbh->prepare($sql);
...
<h5 style="text-align:center;">Second IA Result</h5>

<?php 
$sql = "SELECT distinct tblstudents.StudentName,tblstudents.StudentId,tblclasses.branch_name,tblclasses.sem,tblsubjects.SubjectName,tbliaresult.marks,tbliaresult.id as resultid from tbliaresult join tblstudents on tblstudents.StudentId=tbliaresult.StudentId join tblsubjects on tblsubjects.id=tbliaresult.SubjectId join tblclasses on tblclasses.id=tblstudents.BranchId where tblstudents.StudentId=:stid and tbliaresult.iatype='second' ";
$query = $dbh->prepare($sql);
$query->bindParam(':stid',$stid,PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
<h5 style="text-align:center;">Final IA Result</h5>




<?php 
$sql = "SELECT distinct tblstudents.StudentName,tblstudents.StudentId,tblclasses.branch_name,tblclasses.sem,tblsubjects.SubjectName,tbliaresult.marks,tbliaresult.id as resultid from tbliaresult join tblstudents on tblstudents.StudentId=tbliaresult.StudentId join tblsubjects on tblsubjects.id=tbliaresult.SubjectId join tblclasses on tblclasses.id=tblstudents.BranchId where tblstudents.StudentId=:stid and tbliaresult.iatype='third' ";
$query = $dbh->prepare($sql);
$query->bindParam(':stid',$stid,PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);

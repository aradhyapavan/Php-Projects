...
<head>
  ...
  <title>BCE Student Sem Results</title>
  ...
  <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="sem-results.php">Sem Results</a>
          </li>
          <li class="breadcrumb-item active">Sem Result</li>
        </ol>
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
                        ...
                        <h1 style="text-align:center;" class="border-bottom">Sem Result </h1>
...
<option>8</option> </select> 
                            ...
                            <div class="form-group">
                              </div><button class="btn btn-danger btn-block" type="submit" name="submit" id="submit" >View Results</button></form>
                           <hr />

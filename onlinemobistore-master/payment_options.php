...
<a href="payment.php?c_id=<?php echo $customer_id; ?>">Cash On Delivery</a>
...
<input type="hidden" name="business" value="aradhyapvan@hotmail.com">
...
<input type="hidden" name="return" value="http://localhost:1234/miniproject/mobistore/paypal_order.php?c_id=<?php echo $customer_id; ?>">


<input type="hidden" name="cancel_return" value="http://localhost:1234/miniproject/mobistore/index.php">

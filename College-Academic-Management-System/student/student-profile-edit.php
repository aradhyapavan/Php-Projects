...
$update_student = "update student set  StudentPhoto='$photo',sname='$u_sname',USN='$u_USN',s_email='$u_email',mobile_no='$u_mobile_no',branch='$u_branch',scheme='$u_scheme',DOB='$u_dob',Gender='$u_gender'where USN='$USN'";
...
echo "<script>window.open('student-profile','_self')</script>";
...
<?php } ?></div>
               </div><input type="file" class="form-control" id="photo" name="photo"   value="<?php echo htmlentities($row_student['StudentPhoto']);?>" /></div>
...
<input class="form-control" type="text" name="mobile_no" id="mobile_no" maxlength="10" value="<?php echo $mobile_no; ?>" autocomplete="off" required /></div>
                   </div>
               </div>
...
<div class="form-row">
                   <div class="col-sm-12 col-md-6">
                       <div class="form-group"><label >DOB</label>
                                                       ...
                                                       <input type="date" name="dob" id="dob" class="form-control"  value="<?php echo $dob; ?>"></div>
                   </div>
                   <div class="col-sm-12 col-md-6">
...
{
?>
<input type="radio" name="gender" id="gender" value="Male" required="required" checked>Male <input type="radio" name="gender" value="Female" required="required">Female 
<?php }?>
<?php  
if($gender=="Female")
{
?>
<input type="radio" name="gender" id="gender" value="Male" required="required" >Male <input type="radio" name="gender" value="Female" required="required" checked>Female
<?php }?>
               ...
               <hr>
                       ...
                       </div><button class="btn btn-danger btn-block" type="submit" name="update" id="update" >Update</button></div>
...
echo "<script>window.open('student-profile.php','_self')</script>";

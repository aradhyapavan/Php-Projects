...
<head>
  ...
  <title>Bce Student Attendence</title>
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
                       ...
                       <form  action="../admin/view_attendence" method="post" >
                       <h1 style="text-align:center;" class="border-bottom">Attendence </h1>
...
<option>8</option> </select> 
                            ...
                            <div class="form-group">
                              </div><button class="btn btn-danger btn-block" type="submit" name="submit" id="submit" >View Attendence</button></form>
                           <hr />

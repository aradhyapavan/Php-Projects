...
move_uploaded_file($files_tmp,"../admin/question-papers/$files");
...
$ret=mysqli_query($con,"insert into oldpapers(description,branchid,subjectcode,year,file_type,file_size,files) values('$description','$Branch','$sub','$year','$file_type','$file_size','$files')");
...
<html lang="en">
    <head>
        ...
        <title>BCE Admin question papers< </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Add Question Papers</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Subjects</li>
                                        <li class="active">Add Question Papers</li>
                                    </ul>
                                </div>

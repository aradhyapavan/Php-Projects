...
$sql="INSERT INTO  tblresult(StudentId,BranchId,SubjectId,marks) VALUES(:studentid,:Branch,:sid,:marks)";
...
<html lang="en">
    <head>
        ...
        <title>BCE Admin Add Sem Result </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Declare Sem Result</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Student Sem Result</li>
                                    </ul>
                                </div>

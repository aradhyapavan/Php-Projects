                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT tblstudents.StudentName,tblstudents.USN,tblstudents.year,tblclasses.branch_name,tblclasses.sem,tblstudents.StudentId  from tblstudents join tblclasses on tblclasses.id=tblstudents.BranchId";

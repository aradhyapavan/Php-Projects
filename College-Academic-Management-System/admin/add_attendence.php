...
$sql="INSERT INTO  attendence(StudentId,BranchId,iatype,SubjectId,TCT,TCA) VALUES(:studentid,:Branch,:iatype,:sid,:tct,:marks)";
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Declare Attendence</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Student Attendence</li>
                                    </ul>
                                </div>
...
<div class="form-group">
                                                        <label class="col-sm-2 control-label ">Attendence During</label>
                                                        <div class="col-sm-10">
                                              ...
                                              <div class="form-group">
                                                        <label class="col-sm-2 control-label ">Total ClassesTaken</label>
                                                        <div class="col-sm-10">
                                               <input type="text" name="tct" class="form-control" id="tct" required="required" autocomplete="off">
...
<div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" name="submit" id="submit" class="btn btn-primary">Declare Attendence </button>
                                                        </div>
                                                    </div>
                                                </form>

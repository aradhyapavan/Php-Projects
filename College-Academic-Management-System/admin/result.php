                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Student Results</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
<tr>
                                                <th scope="row" colspan="2">Download Result</th>           
                                                            <td><b><a href="download-result.php"><button   class="btn btn-primary "><i class="fa fa-download"></i> Download</button> </a> </b></td>
                                                             </tr>
...
?>
                                    ...
                                    <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                               <a href="../student/sem-results">Back to Home</a>
                                                            </div>
                                                        </div>

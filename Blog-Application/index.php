...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a href="#" class="navbar-brand"> Sughosh Suggi</a>
    ...
    <div class="container">
      <div class="row mt-4">
        ...
        <!-- Main Area Start-->
        <div class="col-sm-8 ">
          <h1> Blogs And Storie By</h1>
          <h1 class="lead">Sughosh Suggi</h1>
          <?php
           echo ErrorMessage();
           echo SuccessMessage();
           ?>
...
<div class="f3">
<a class="btn btn-large btn-outline" href="Blog.php?page=1" role="button">All Blogs</a>
</div> 
</div>
<div class="col-lg-4">
</div>
...
<br>
    ...
    <footer class="bg-dark text-white">
      <div class="container">
        <div class="row">
          <div class="col">
          <p class="lead text-center">Ardent Connect <span id="year"></span> &copy; ----All right Reserved.</p>
           </div>
         </div>
      </div>
    </footer>
